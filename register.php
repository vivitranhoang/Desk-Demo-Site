...
if($_SERVER["REQUEST_METHOD"] == "POST"){
    ...
    if(empty($name_err) && empty($username_err) && empty($email_err) && empty($password_err) && empty($confirm_password_err)){
        ...
        if($stmt = mysqli_prepare($conn, $sql)){
            ...
            // Attempt to execute the prepared statement
            if(mysqli_stmt_execute($stmt)){
                echo "Thank you for joining us! You may now log in.";
...
<body>
    ...
    <br><div class="outside"><img src="oneofus.jpg" alt="photo of orange crab penholder holding a TWSBI rose gold fountain pen" width="1000" />
        <br><p>The crab beckons you to join us.</p> </div>   
</body>
</html>
<br>
